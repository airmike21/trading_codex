...
- Last completed milestone: the Brain-in-Codex cutover pack is already part of promoted repo truth, adding the repo-root Codex startup/standing instructions plus the first-pass cutover checklist while leaving the Stage 2 forward-evidence hold, the reopened explicit shadow pair, and the bounded shadow-only queue unchanged in substance
- Runtime / lane status:
