...
def test_hide_low_priority_checkbox_narrows_recent_activity_only(tmp_path: Path) -> None:
    archive_root = Path(os.environ["TRADING_CODEX_ARCHIVE_ROOT"])
    _seed_triage_filter_runs(archive_root)
